...
\subsection[Csavar katalógus]{Csavar katalógus\protect\footnote{\href{https://www.k-mechanic.hu/kmchnc17/wp-content/uploads/2021/04/Csavarok.pdf}{ISO 4014} katalógus alapján kapott értékek.}}
\begin{align*}
	& p = \siunit{\csavarp}{\mm} \\
...
\begin{center}
	\begin{tabular}{l}
		...
		$\mu_{\substack{\text{min}\\\text{max}}}/\mu$: súrlódási tényező\footnote{\href{https://web.archive.org/web/20190713023654/http://www.sze.hu/~szalai/szabvanyok/Anyagok.pdf}{MSZ EN 24014} katalógus alapján kapott értékek.}\textsuperscript{,}\footnote{A súrlódási tényező átlagolható elég nagy biztonsági tényező mellett.} \siunit{}{-} \\
	\end{tabular}
\end{center}
...
\begin{center}
	\begin{tabular}{l}
		...
		$d_\text{cs}$: csavar katalógusos mérete \siunit{}{\mm} \\
